...
- Label reference outputs as Monte Carlo estimates with basic continuation. Neither teacher agreement nor model action confidence is a casino win probability.
